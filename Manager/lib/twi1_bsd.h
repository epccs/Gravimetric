...
typedef enum TWI1_RD_STAT_enum {
    ...
    TWI1_RD_STAT_DATA_NACK, // data receive, NACK sent (to soon)
...
typedef enum TWI1_PROTOCALL_enum {
    TWI1_PROTOCALL_STOP = 0x01, // Stop sending and unlock the bus
    TWI1_PROTOCALL_REPEATEDSTART = 0x02 // lock the bus and wait for more to send
} TWI1_PROTOCALL_t;
