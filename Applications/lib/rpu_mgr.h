...
extern void i2c_battery_cmd(uint8_t my_callback_addr, uint8_t my_callback_route, uint8_t enable);
extern void i2c_shutdown_cmd(uint8_t my_callback_addr, uint8_t my_callback_route, uint8_t cntl);
